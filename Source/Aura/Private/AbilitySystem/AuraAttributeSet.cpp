...
void UAuraAttributeSet::SetEffectProperties(const FGameplayEffectModCallbackData& EffectData, FEffectProperties& Props) const
{
	...
	if (IsValid(Props.SourceASC) && IsValid(Props.SourceASC->GetAvatarActor()))
	{
		...
		{
			//Fallback if AbilityActorInfo doesn't have Controller and SourceController == nullptr
	...
	{
		Props.TargetAvatarActor = EffectData.Target.GetAvatarActor();
...
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, FireResistance, OldLightningResistance);
}

void UAuraAttributeSet::OnRep_ArcaneResistance(const FGameplayAttributeData& OldArcaneResistance) const
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, FireResistance, OldArcaneResistance);
}

void UAuraAttributeSet::OnRep_PhysicalResistance(const FGameplayAttributeData& OldPhysicalResistance) const
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, FireResistance, OldPhysicalResistance);
}
