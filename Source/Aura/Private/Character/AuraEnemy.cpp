...
void AAuraEnemy::PossessedBy(AController* installedController)
{
	Super::PossessedBy(installedController);
	
	if (!HasAuthority()) return;
	
	AuraAIController = Cast<AAuraAIController>(installedController);
